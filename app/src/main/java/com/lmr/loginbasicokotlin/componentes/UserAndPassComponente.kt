package com.lmr.loginbasicokotlin.componentes
...
/**
 * Añadido para poder usar el icono de visibilidad de la contraseña, es copiado de los ejemplos
 * de google, se supone que esto iba en una librería, pero no hay forma de hacerlo funcionar así
 * que lo añado manualmente, y parece que funciona bien.
 */
